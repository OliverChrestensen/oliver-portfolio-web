        ...
        {projects.map((project, index) => (
          <Link key={project.slug} href={`/projects/${project.slug}`}>
            <motion.div
              ...
              className={`group bg-gradient-to-br ${project.color} p-6 rounded-2xl border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105 hover:shadow-2xl shadow-xl relative cursor-pointer`}
            >
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <p className="text-white/80 text-sm mb-4 leading-relaxed">{project.shortDescription}</p>
                </motion.div>
